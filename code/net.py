...
def HistoNet(num_bins, patch_size = 32):
    ...
    Output:
    net: output redundant count map
    net12: output histogram
    ...
    print("\n Resnet Hist Head")
    _ ,net12 = resnet50(net1, num_bins)
    
    print("\n Count Head")
    net = ConvFactory(net11, filter_size=1, num_filter=1)
    print(net.output_shape)

    return net, net12, input_var, input_var_ex
...
def HistoNet_DSN(num_bins = [2,4,8], patch_size = 32):
    ...
    Output:
    net: output redundant count map
    net12: output histogram of size num_bins[2]
    ...
    print("\n Resnet Hist Head")
    _ ,net12, dsn_1, dsn_2 = resnet50_DSN(net1, num_bins)    

    print("\n Count Head")
    net = ConvFactory(net11, filter_size=1, num_filter=1)
    print(net.output_shape)

    return net, net12, dsn_1, dsn_2, input_var, input_var_ex
